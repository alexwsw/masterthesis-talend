...
public class ColumnManager {
	...
	public List<ColumnObject> getColumnsForTable(String database, String tableName, String schema, String... columnNames) {
		List<ColumnDTO> columns = new ArrayList<ColumnDTO>();
		ResultSet rs = performer.getMetadataForColumns(database, tableName, schema, columnNames);
