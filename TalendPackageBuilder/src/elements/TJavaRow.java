...
public class TJavaRow implements ICustomCode {

	private IFinder finder;
	private Document document;
	private IXmlBuilder builder;
	private static final String elementName = "tJavaRow";
	
	public TJavaRow(Document document, IFinder finder, IXmlBuilder builder) {
		this.finder = finder;
	...
	public void setCodedContent(Node node, String code) {
		setElement(node, "CODE", code);
		
	}

	@Override
	public void setImports(Node node, String imports) {
		setElement(node, "IMPORT", imports);
